...
| Week | Topic | Resource | Practice |
|------|-------|----------|----------|
| 1-2 | ML Fundamentals | [ML Overview](intermediate/01_ml_fundamentals.ipynb) | Implement linear regression from scratch |
| 3-4 | Supervised Learning | [Classification & Regression](intermediate/02_supervised_learning.ipynb) | Kaggle House Prices |
...
| Book | Author | Link |
|------|--------|------|
| Python Data Science Handbook | Jake VanderPlas | [Free on GitHub](https://github.com/jakevdp/PythonDataScienceHandbook) |
| Hands-on ML with Scikit-Learn, Keras, TF | Aurélien Géron | [GitHub notebooks](https://github.com/ageron/handson-ml3) |
| Dive into Deep Learning | Zhang et al. | [d2l.ai](https://d2l.ai) |
| Think Stats | Allen Downey | [Green Tea Press (free)](https://greenteapress.com/thinkstats/) |
| The Elements of Statistical Learning | Hastie et al. | [Free PDF (official)](https://hastie.su.domains/ElemStatLearn/) |
...
- [LeetCode](https://leetcode.com) — SQL and Python practice
...
- [DS Interview Questions →](../06_Interview_Prep/data_scientist/)
